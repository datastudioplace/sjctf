package com.demos.lambdaAndstreams.collectMethods.groupBy4.summarizing;
...
public class SummarizingDoubleExample3 {
  ...
  public static void main(String[] args) {
    ...
    DoubleSummaryStatistics output1 =
        list.stream().collect(Collectors.summarizingDouble((x -> x.length())));
