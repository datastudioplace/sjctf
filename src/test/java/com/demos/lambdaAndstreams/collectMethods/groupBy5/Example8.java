...
public class Example8 {
  ...
  public static void main(String[] args) {
    ...
    Map<String, List<Student>> counting =
        items.stream().collect(Collectors.groupingBy(Student::getName));
    ...
    Map<Integer, Set<String>> map =
        getListOfStudents_1().stream()
            .collect(
                Collectors.groupingBy(
                    Student::getAge, Collectors.mapping(Student::getName, Collectors.toSet())));
