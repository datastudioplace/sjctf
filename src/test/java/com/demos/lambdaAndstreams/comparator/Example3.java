package com.demos.lambdaAndstreams.comparator;
...
public class Example3 {
  ...
  static Comparator<Person2> employeeSalaryComparator =
      Comparator.comparing(
          Person2::getEmployee, (o1, o2) -> o1.getSalary().compareTo(o2.getSalary()));
  ...
  static Comparator<Person2> employeeSalaryComparator10 =
      Comparator.comparing(Person2::getLastName).thenComparing(Person2::getFirstName);

  static Comparator<Person2> employeeSalaryComparator2 =
      Comparator.comparingDouble(e -> e.getEmployee().getSalary());

  static Comparator<Person2> comparingLong =
      Comparator.comparingLong(e -> e.getEmployee().getSalary());

  static Comparator<Person2> employeeDesignationComparator =
      Comparator.comparing(e -> e.getEmployee().getDesignation());
  ...
  static Comparator<Person2> employeeDesignationComparator2 =
      Comparator.comparing(
          e -> e.getEmployee(), (o1, o2) -> o1.getDesignation().compareTo(o2.getDesignation()));
  ...
  public static void main(String[] args) {
    ...
    Collections.sort(
        arrayList, Comparator.comparing(Person2::getFirstName).thenComparing(Person2::getAge));
