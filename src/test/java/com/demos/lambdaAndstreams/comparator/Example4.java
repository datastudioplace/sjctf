...
public class Example4 {
  ...
  public static void main(String[] args) {
    ...
    Collections.sort(
        arrayList, Comparator.comparing(Person1::getFirstName).thenComparing(Person1::getAge));
  }
}
