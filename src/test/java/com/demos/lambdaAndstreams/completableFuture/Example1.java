package com.demos.lambdaAndstreams.completableFuture;
...
public class Example1 {
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    CompletableFuture<String> future =
        primaryFuture.applyToEither(
            secondaryFuture, student -> student.getName() + " - " + student.getAge());
    ...
    CompletableFuture<Object> finalResult =
        output1.applyToEither(output2, x -> x.concat("I am test"));

    System.out.println(finalResult.get());

    CompletableFuture<String> output3 =
