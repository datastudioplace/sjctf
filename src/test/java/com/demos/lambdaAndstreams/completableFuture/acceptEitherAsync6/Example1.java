package com.demos.lambdaAndstreams.completableFuture.acceptEitherAsync6;
...
public class Example1 {
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    completableFuture1.acceptEitherAsync(
        CompletableFuture.supplyAsync(() -> 5), x -> System.out.println(x));
