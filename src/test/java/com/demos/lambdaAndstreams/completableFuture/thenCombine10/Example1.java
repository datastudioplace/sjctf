package com.demos.lambdaAndstreams.completableFuture.thenCombine10;
  ...
  public static void main(String[] args) throws InterruptedException, ExecutionException {
    ...
    CompletableFuture<Void> future =
        supplyAsync(supplier)
            .thenCombine(
                supplyAsync(Example1::getVeggies),
    ...
    // exception
    // in case the Future does not complete normally. This makes it possible to use it as a method
