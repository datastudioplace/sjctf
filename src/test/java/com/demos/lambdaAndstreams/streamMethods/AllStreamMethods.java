package com.demos.lambdaAndstreams.streamMethods;
...
public class AllStreamMethods {
  ...
  public static void main(String[] args) {
    ...
    // Returns whether all elements of this com.demos.lambdaAndstreams.stream match the provided predicate.
    list.stream().allMatch(predicate);

    // anyMatch(Predicate<? super T> predicate)
    // Returns whether any elements of this com.demos.lambdaAndstreams.stream match the provided predicate.
    list.stream().anyMatch(predicate);

    // collect(Collector<? super T,A,R> collector)
    // Performs a mutable reduction operation on the elements of this com.demos.lambdaAndstreams.stream using
    // a Collector.
    list.stream().collect(Collectors.toList());

    // collect(Supplier<R> supplier, BiConsumer<R,? super T> accumulator, BiConsumer<R,R> combiner)
    // Performs a mutable reduction operation on the elements of this com.demos.lambdaAndstreams.stream.
    list1.stream().collect(ArrayList::new, ArrayList::add, ArrayList::addAll);

    // Returns the count of elements in this com.demos.lambdaAndstreams.stream.
    // count()
    list.stream().count();

    // distinct()
    // Returns a com.demos.lambdaAndstreams.stream consisting of the distinct elements
    // (according to Object.equals(Object)) of this com.demos.lambdaAndstreams.stream.
