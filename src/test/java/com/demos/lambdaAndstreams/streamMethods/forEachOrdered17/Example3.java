package com.demos.lambdaAndstreams.streamMethods.forEachOrdered17;
...
public class Example3 {
  ...
  public static void main(String[] args) {
    ...
    // list.com.demos.lambdaAndstreams.stream().sorted(Comparator.reverseOrder()).forEachOrdered(System.out::println);
