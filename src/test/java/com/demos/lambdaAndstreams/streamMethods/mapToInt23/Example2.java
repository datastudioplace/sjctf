package com.demos.lambdaAndstreams.streamMethods.mapToInt23;
...
public class Example2 {
  ...
  public static void main(String[] args) {
    ...
    Map<Integer, Long> newData =
        newList.boxed().collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
