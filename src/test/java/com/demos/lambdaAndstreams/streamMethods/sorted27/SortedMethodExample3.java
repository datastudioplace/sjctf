...
public class SortedMethodExample3 {
  ...
  public static void main(String[] args) {
    ...
    Set<Employee> setData =
        set.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toSet());
    ...
    Stream<Employee> setData1 =
        Employee.getListOfEmployees().stream().sorted(Comparator.reverseOrder());
