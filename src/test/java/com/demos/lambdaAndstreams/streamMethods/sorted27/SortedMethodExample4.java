package com.demos.lambdaAndstreams.streamMethods.sorted27;
...
import com.demos.lambdaAndstreams.streamMethods.Employee;
...
public class SortedMethodExample4 {
  ...
  public static void main(String[] args) {
    ...
    // set.com.demos.lambdaAndstreams.stream().sorted(Comparator.reverseOrder()).collect(Collectors.toMap(function2, function3));
    // System.out.println(map1);

    System.out.println("==================");

    Map<String, Integer> map1 =
        set.stream().sorted().collect(Collectors.toMap(function2, function3, (o1, o2) -> o1 + o2));
    ...
    System.out.println("==================");
    Set<Employee> set45 = set.stream().sorted().collect(Collectors.toSet());
