...
import com.localhost8888.helperutilities.ProcessFileResouce;
import com.localhost8888.restcalls.HTTPClientGet;
...
public class GenericMicroServiceTestSteps {
  ...
  public void theResponseShouldBeWith(String arg0, String arg1) throws Throwable {
    ...
    if (bPost) {
      ...
      responseFile = new ProcessFileResouce(arg0);
      Assert.assertEquals(
          responseFile.getJsonObject().toString(), httpClientGet.getResponseOutput());
