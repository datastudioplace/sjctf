...
public class FieldInputUtils {
  ...
  public static void inputFieldValueBasedOnValueType(
      String valueType, int numberOfChars, WebElement element, String caseType) {
    if (element != null) {
      element.clear();
      if (valueType.equals("Number")) {
        ...
        element.sendKeys(
            TextGeneratorUtils.generateStringWithLengthAndCase(numberOfChars, caseType));
        ...
        element.sendKeys(
            EmailGeneratorUtils.generateEmailWithTextAndLengthLessThanFiveChars(
                numberOfChars, caseType));
        ...
        element.sendKeys(
            EmailGeneratorUtils.generateEmailWithNumbersAndLengthLessThanFiveChars(numberOfChars));
      }
    }
  }
}
