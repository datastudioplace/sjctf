...
public class FileUtils {
  ...
  public static void deleteReportingFiles() {
    String[] reportingFileNames = {
      "EQUAL_OPPORTUNITIES",
      "APPLICATION_EXPORT",
      "EQUAL_OPPORTUNITIES_",
      "TIME_TAKEN_TO_HIRE",
      "VACANCY_NUMBERS",
      "VACANCY_BULLETIN",
      "masterFlex-output"
    ...
    for (File f : fList) {
      for (int i = 0; i < reportingFileNames.length; i++) {
        if (f.getName().contains(reportingFileNames[i])) f.delete();
      }
    }
  }
  ...
  public static Map<String, String> getMapFromCSV(final String filePath, String headerKey)
      throws IOException {
