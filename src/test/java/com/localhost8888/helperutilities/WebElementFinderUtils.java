...
public class WebElementFinderUtils {
  ...
  public static List<WebElement> findAllChildElementsOfParentElementInActualOrder(
      String idOfParentElement) {
  ...
  public static List<WebElement> findAllTableRows(String idOfTableBodyElement) {
    List<WebElement> childWebElementsInActualOrder =
        findAllChildElementsOfParentElementInActualOrder(idOfTableBodyElement);
  ...
  public static List<WebElement> findAllChildElementsOfParentElementInActualOrder(
      WebElement parentWebElement) {
    List<WebElement> childWebElementsInActualOrder =
        parentWebElement.findElements(By.xpath(".//*"));
    String tagName =
        childWebElementsInActualOrder.get(childWebElementsInActualOrder.size() - 1).getText();
