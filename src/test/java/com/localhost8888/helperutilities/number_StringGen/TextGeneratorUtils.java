package com.localhost8888.helperutilities.number_StringGen;
...
public class TextGeneratorUtils {
  ...
  private static String generateString() {
    String generatedString =
        repeatableChar.replace(
            repeatableChar, String.join("", Collections.nCopies(charCount, repeatableChar)));
