package com.localhost8888.testData.propertiesFiles;
...
public class GlobalVars {
  ...
  public static final String DATAPROVIDER_JSONPATH =
      System.getProperty("user.dir")
          + "//src//test//java//com.localhost8888.testData//data//Register.json";

  public static final String URL_HOMEPAGE = "https://automationteststore.com/index.php";
  public static final String GOOGLE_HOMEPAGE_URL = "https://www.google.co.uk/";
  public static final String ACCOUNTCREATEPAGE_URL =
  ...
  public static final String ACCOUNTCREATEPAGE_TITLE = "Register Account";
  public static final String ACCOUNT_LOGIN_TXT = "ACCOUNT LOGIN";
  ...
  public static final String myAccountInformation = "My Account Information";
  public static final String REGISTER_JSON_PATH =
      "//src//test//java//opencart//com.localhost8888.testData.data//createAnAccount.json";

  public static final String recoveryPassword_Username = "benazeta70";
  public static final String username = "webdriverio2";
  public static final String loginName = "webdriverio2";
  public static final String password = "webdriverio2";
  public static final String myAccount = "My Account";
  public static final String accountSuccessfullyUpdated =
      "Success: Your account has been Success: Your account has been successfully updated..";

  public static final String wrong_password = "Password_Wrong";
  public static final String pass_word = "Password";

  public static final String CONTINUE_BTN_TEXT = "Continue";

  public static final String HOMEPAGE_TITLE = "Your Store";
  public static final String ACCOUNT_LOGOUT_HEADER = "Account Logout";
  public static final String ACCOUNT_EDIT_URL_PATH = "account/edit";
  public static final String PRODUCTNAME_1 = "Skinsheen Bronzer Stick";
  public static final String Benefit_Bella_Bamba = "Benefit Bella Bamba";
  public static final String PRODUCTNAME_3 = "Absolue Eye Precious Cells";

  // =================================================================//
  public static final String LASTNAME = "John";
  public static final String FIRSTNAME = "Doe";
  public static final String TELEPHONE = "0740500000000";
  public static final String FAX = "0740500000001";
  public static final String loginname_password = "benazeta70";
  public static final String email_password = "benazeta70@gmail.com";
  public static final String lastname = "Zeta";
  public static final String emailAddress = "email001@email.com";
  public static final String wrongPassword = "WrongPassword00";

  public static final String INCORRECT_LOGIN_PASSWORD_PROVIDED =
      "Warning: No match for E-Mail Address and/or Password.";
  public static final String RECOVERY_PASSWORD_SUCCESS_MSG =
      "Success: Password reset link has been sent to your e-mail address";
  public static final String RECOVERY_LOGINNAME_SUCCESS_MSG =
      "Success: Your login name reminder has been sent to your e-mail address.";

  public static final String FORGET_YOUR_PASSWORD_LINK_TXT = "Forgot your password?";
  public static final String FORGET_YOUR_LOGINNAME_LINK_TXT = "Forgot your login?";
  public static final int explicitWait = 15;
  public static final int EXPLICITWAIT = 5;

  public static final int SHORT_IMPLICIT_WAIT_TIME = 5;
  ...
  public static final int expWait = 2;
  ...
  public static final int DEFAULT_EXPLICIT_TIMEOUT = 15;

  public static final int EXPLICIT_TIMEOUT = 30;
  public static final int POLLING_TIMEOUT = 250;
  public static final int PAGELOAD_TIMEOUT = 120;

  public static final int DEFAULT_IMPLICIT_TIMEOUT = 7;
  ...
  public static String SKILL_LOOKING_FOR =
      "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String YOUR_ORGANISATION =
      "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  // Job overview Page Data
  public static String UPDATED_JOB_OVERVIEW =
      "Updated Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String UPDATED_SKILL_LOOKING_FOR =
      "Updated Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String UPDATED_YOUR_ORGANISATION =
      "Updated Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  // List the main responsibilities of the job to create your job description Page
  // data
  public static String DUTIES_AND_RESPONSIBILITY =
      "To provide clinical leadership to staff working within the Community Service contract to ensure safe and effective delivery of clinical interventions in line with professional standards and governance requirements";
  ...
  public static String DONE_AND_SCORE_NEXT_APPLICATION_SELECTION =
      "finish and score next application";
  public static String DONE_SCORING_AND_SELECT_SHORTLIST_SELECTION =
      "done scoring and select shortlist";
  public static String DONE_SCORING_AND_RETURN_TO_OVERVIEW =
      "finish and return to scoring overview";
  public static String DONE_AND_RETURN_TO_OVERVIEW_SELECTION =
      "finish and return to scoring overview";
  // Scoring Ranking
  ...
  // Safeguarding com.localhost8888.settings
  public static String SAFEGUARDING_SETTINGS_YES = "Yes, add them to all job applications";
  public static String SAFEGUARDING_SETTINGS_NO =
      "No, let the person creating the listing select if they want to add them";
  ...
  public static String SELECT_PRE_APPLICATION_QUESTION_1 =
      "Do you possess [enter the name] qualification or equivalent?";
  public static String SELECT_PRE_APPLICATION_QUESTION_2 =
      "Do you possess [enter the name] registration?";
  public static String SELECT_PRE_APPLICATION_QUESTION_4 =
      "Have you passed the International Qualifying Exam (IQE) or Overseas registration Exam (ORE)?";
  // Medical Question
  public static String SELECT_PRE_APPLICATION_QUESTION_5 =
      "Are you currently employed by the Employer advertising this vacancy?";
  public static String SELECT_PRE_APPLICATION_QUESTION_6 =
  ...
  public static String WELSH_JOB_OVERVIEW =
      "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String WELSH_SKILL_LOOKING_FOR =
      "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String WELSH_YOUR_ORGANISATION =
      "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String WELSH_DUTIES_AND_RESPONSIBILITY =
      "To provide clinical leadership to staff working within the Community Service contract to ensure safe and effective delivery of clinical interventions in line with professional standards and governance requirements";
  ...
  public static String WELSH_UPDATED_JOB_OVERVIEW =
      "UPDATED Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String WELSH_UPDATED_SKILL_LOOKING_FOR =
      "UPDATED Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  public static String WELSH_UPDATED_YOUR_ORGANISATION =
      "UPDATED Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean ma";
  //	Approval
