package com.localhost8888.testData_customer;
...
public class RegistrationTestData {
  ...
  public static String ENGLISH_SCOTTISH_WELSH =
  ...
  public static String textInput =
      "Make sure your text does not contain any personal information like your name or address, or telephone number that could identify you to the administrator.";
  public static String updatedTextInput =
      "Updated make sure your text does not contain any personal information like your name or address, or telephone number that could identify you to the administrator.";
  ...
  public static String ftpHealthCareDetailsPageContent =
      "We'll need details such as:\n"
  ...
  public static String ftpInvestigationDetailsPageContent =
      "We'll need details such as:\n"
          + "the name and address of the regulatory or licensing body\n"
  ...
  public static String ftpRestrictionsDetailsPageContent =
      "We'll need details such as:\n"
  ...
  public static String APPLICANT_INVALID_JOB_TITLE =
      "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijk01@£%$%^@*!^£(*&$*&^$$%^%:£<><>?%&^^**&(*^*abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijk01@£%$%^@*!^£(*&$*&^$$%^%:£<><>?%&^^**&(*^*";
  public static String APPLICANT_REASON_FOR_LEAVING = "Reason Reason Reason Reason Reason Reason";
  public static String APPLICANT_INVALID_REASON_FOR_LEAVING =
      "abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijk01@£%$%^@*!^£(*&$*&^$$%^%:£<><>?%&^^**&(*^*abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwxyzabcdefghijk01@£%$%^@*!^£(*&$*&^$$%^%:£<><>?%&^^**&(*^*";

  public static String APPLICANT_DECLINE_REASON =
      "Decline Decline Decline Decline Decline Decline Decline Decline";

  public static String APPLICANT_WARNING_DETAILS =
      "Warning Warning Warning Warning Warning Warning Warning";
  public static String APPLICANT_INVALID_WARNING_DETAILS = "Warning Warning";

  public static String APPLICANT_INVESTIGATION_DETAILS =
  ...
  public static String DBS_DETAILS =
  ...
  public static String ESSENTIAL_COOKIES_DETAILS =
      "Name Purpose Expires\n"
          ...
          + "Name Purpose Expires\n"
          + "nhs-jobs-customer Saves your unique user session to keep you logged in 4 hours\n"
          + "Locale\n"
